...
const Hero = () => {
  return (
    <section className="relative bg-slate-50 pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
          <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
            <div className="inline-flex items-center px-4 py-2 rounded-full border border-blue-100 bg-white shadow-sm text-blue-600 text-sm font-semibold mb-6 backdrop-blur-sm">
            ...
            <p className="mt-4 text-base text-slate-600 sm:mt-6 sm:text-lg lg:text-base xl:text-lg leading-relaxed">
            ...
            <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0 flex flex-col sm:flex-row gap-4">
              ...
              <button className="flex items-center justify-center px-8 py-3 border border-slate-200 text-base font-semibold rounded-2xl text-slate-700 bg-white hover:bg-slate-50 md:text-lg shadow-sm hover:shadow-md transition-all">
                Learn More
              </button>
            </div>

            <div className="mt-10 flex items-center gap-6 text-sm text-slate-500 font-medium sm:justify-center lg:justify-start">
          ...
          <div className="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
            <div className="relative mx-auto w-full rounded-3xl shadow-2xl lg:max-w-md overflow-hidden transform rotate-2 hover:rotate-0 transition-all duration-500">
              <div className="relative block w-full bg-blue-100 h-[400px] lg:h-[500px]">
                <img
                ...
                <div className="absolute bottom-8 left-8 right-8 bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-xl border border-white/50">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-slate-500 font-medium">Next Available Slot</p>
                      <p className="text-lg font-bold text-slate-900">Today, 2:00 PM</p>
                    </div>
                  </div>
                </div>
              </div>
