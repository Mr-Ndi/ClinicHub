...
const DashboardLayout = () => {
    ...
    const menuItems = [
        ...
        {
            name: 'Settings', path: '/doctor/settings', icon: (
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex">
            {/* Sidebar */}
            <aside className={`bg-white border-r border-slate-200 fixed h-full z-30 transition-all duration-300 ${isSidebarOpen ? 'w-64' : 'w-20'}`}>
                <div className="h-16 flex items-center justify-center border-b border-slate-100">
                    <div className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
                            <span className="text-white font-bold text-xl">C</span>
                        </div>
                        {isSidebarOpen && <span className="text-slate-900 text-xl font-bold tracking-tight">Clinic<span className="text-blue-600">Hub</span></span>}
                    </div>
                </div>
