...
const DashboardLayout = () => {
    ...
    const menuItems = [
        ...
        { path: '/doctor/prescriptions', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', label: 'Prescriptions' },
                    ...
                    <div className="flex items-center gap-4">
                        <Link to="/doctor/profile" className="flex items-center gap-4 hover:bg-slate-50 dark:hover:bg-slate-800 p-2 rounded-xl transition-colors group">
                            <div className="text-right hidden sm:block">
                                <p className="text-sm font-semibold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">Dr. Sarah Johnson</p>
