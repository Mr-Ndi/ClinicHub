    ...
    return (
        <div>
            <div className="mb-8">
                ...
                <p className="text-slate-600 dark:text-slate-400">Manage system configuration</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 p-8 text-center">
                ...
                <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto">
                    This section will allow you to configure general system settings, manage roles, and view audit logs.
                </p>
            </div>
        </div>
    );
