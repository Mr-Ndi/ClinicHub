        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        {recentActivity.map((item, index) => (
                            <div key={index} className="flex items-start gap-4 pb-6 border-b border-slate-50 last:border-0 last:pb-0">
                                ...
                                <div>
                                    <p className="text-slate-900 font-medium">{item.patient}</p>
                ...
                <div className="bg-blue-600 p-6 rounded-2xl text-white shadow-lg shadow-blue-600/20">
                    ...
                    <button className="w-full mt-6 py-3 bg-white text-blue-600 rounded-xl font-bold hover:bg-blue-50 transition-colors">
                        View All
                    </button>
                </div>
            </div>
